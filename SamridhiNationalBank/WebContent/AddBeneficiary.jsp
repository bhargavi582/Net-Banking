...
<div class="container" style="margin-top:0px">
  <nav class="navbar navbar-expand-lg navbar-light bg-info text-light py-1 main-nav">
          <div class="container">
            <a class="navbar-brand" href="CustomerHomePage.jsp"><img src="logoonline.jpg" alt="Logo"></a>
...
Welcome <%=customer.getFirstName() + " " + customer.getLastName()%></font>
  ...
  <a class="active" href="AddBeneficiary.jsp">Add Beneficiaries</a> 
  <a href="DeleteBeneficiary.jsp">Delete Beneficiaries</a>
</div><br/>
<form action="AddBeneficiariesServlet" method="post" oninput='bAccNo1.setCustomValidity(bAccNo1.value != bAccNo.value ? "Account numbers do not match." : "")'class="form-horizontal" role="form">
    
    <div class="row">
                    <label for="Beneficiary Name" class="col-sm-5 control-label">Beneficiary Name<font color="red">*</font></label>
                    <div class="col-sm-5">
                        <input type="text" id="Beneficiary  Name" name="bName" placeholder="Beneficiary Name"required class="form-control" autofocus>
                    </div>
                </div><br/>
                <div class="row">
                    <label for="Beneficiary AccNumber" class="col-sm-5 control-label">Beneficiary Account Number<font color="red">*</font></label>
                    <div class="col-sm-5">
                        <input type="text" id="Beneficiary  AccNumber" name="bAccNo" placeholder="Beneficiary Account Number"required class="form-control" autofocus>
                    </div>
                </div><br/>
                <div class="row">
                    <label for="Beneficiary AccNumber" class="col-sm-5 control-label">Confirm Beneficiary Account Number<font color="red">*</font></label>
                    <div class="col-sm-5">
                        <input type="text" id="Beneficiary  AccNumber" name="bAccNo1" placeholder="Confirm Beneficiary Account Number"required class="form-control" autofocus>
                    </div>
                </div><br/>
                <div class="row">
                    <label for="Transaction Limit" class="col-sm-5 control-label">Enter Transaction Limit<font color="red">*</font></label>
                    <div class="col-sm-5">
                        <input type="text" id="Beneficiary  AccNumber" name="limit" placeholder="Transaction Limit" required class="form-control" autofocus>
                    </div>
                </div><br/>
                <span style="display:inline-block; width: 400px;"></span> <button type="submit" class="btn btn-sm btn-success" action="AddBeneficiariesServlet">PROCEED</button>
